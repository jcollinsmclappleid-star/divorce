...
async function seedProducts() {
  ...
  const product = await stripe.products.create({
    ...
    description: 'Full structured financial modelling analysis for UK divorce proceedings. Includes scenario comparison, stability scoring, sensitivity testing, 12-month snapshots, 5-year projections, and downloadable Settlement Reality Check PDF. Unlimited re-runs for 12 months.',
    metadata: {
