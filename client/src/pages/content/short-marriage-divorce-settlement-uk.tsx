...
const principles = [
  ...
  { title: "Pre-marital assets are more strongly protected", desc: "Wealth either party brought into the marriage is much more likely to be ring-fenced as 'non-matrimonial' in a short marriage, especially if the assets have been kept separate." },
...
const faqItems = [
  ...
  {
    question: "Will my pre-marital assets be protected in a short marriage?",
    answer: "Generally yes — much more so than in a long marriage. Assets you brought into the marriage that have been kept separate are likely to be treated as non-matrimonial and ring-fenced from sharing. However, if they have been used for the family or mingled with matrimonial wealth, that protection erodes.",
  },
  {
    ...
    >
      ...
      <ContentSection>
        ...
        <div className="space-y-3 mb-6">
          {[
            { label: "Mingling of pre-marital assets", desc: "Even in short marriages, pre-marital assets that have been mingled (for example, sale proceeds put into a jointly-owned home) may lose their protected status. Keeping pre-marital wealth in separate accounts strengthens the ring-fencing argument." },
      ...
      <ContentSection muted>
        ...
        <div className="space-y-3 mb-6">
          {[
            ...
            "How much pre-marital wealth a court would ring-fence in your case",
            "The weight a court would give to pre-marital cohabitation in your situation",
          ].map((item, i) => (
        ...
        <ul className="space-y-2 text-sm text-muted-foreground list-disc pl-5 mb-6">
          ...
          <li>Which of my pre-marital assets are likely to be ring-fenced?</li>
