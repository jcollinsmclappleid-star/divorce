        ...
        <div className="space-y-8">
          ...
          <div className="text-center space-y-3">
            ...
            <div className="flex flex-wrap justify-center gap-3 text-sm">
              <Link href="/how-much-does-divorce-cost-uk" className="text-primary hover:underline">Divorce costs</Link>
              <Link href="/divorce-financial-settlement-calculator-uk" className="text-primary hover:underline">How assets are divided</Link>
