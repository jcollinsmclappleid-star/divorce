...
const faqItems = [
  ...
  { question: "What about pensions and IHT after divorce?", answer: "Most UK pensions sit outside the estate for IHT and pay out at the trustees' discretion. The pension scheme uses your most recent 'expression of wish' nomination as a key guide. After divorce, nominations are commonly reviewed and updated — leaving an old nomination in place can result in death benefits being paid to a former spouse rather than to children or new partners. Decisions about nominations are personal and a STEP-qualified solicitor or IFA can advise on your circumstances." },
