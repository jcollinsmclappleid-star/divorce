  ...
  const sections = [
    {
      ...
      links: [
        ...
        { href: "/who-pays-mortgage-during-divorce-uk", label: "Who pays the mortgage during divorce?", desc: "What to check about mortgage payments while separation proceedings are ongoing." },
    ...
    },
    {
      ...
      links: [
        ...
        { href: "/what-am-i-entitled-to-in-divorce-uk", label: "What financial checks matter in a UK divorce?", desc: "How the framework may play out — needs, sharing, and the role of contributions." },
        { href: "/how-much-will-i-get-divorce-uk", label: "How much will I get in a divorce?", desc: "Model your share of property, pensions and monthly costs — without a solicitor first." },
    ...
    },
    {
      ...
      links: [
        ...
        { href: "/matrimonial-vs-non-matrimonial-assets-uk", label: "Matrimonial vs non-matrimonial assets", desc: "What may need separate review — and what evidence matters." },
        { href: "/pre-marital-assets-divorce-uk", label: "Pre-marital assets in divorce", desc: "How assets brought into the marriage are treated — and what evidence to check." },
    ...
    },
    {
      ...
      links: [
        ...
        { href: "/career-sacrifice-divorce-settlement-uk", label: "Career sacrifice and divorce settlement", desc: "How stepping back from paid work may be weighed — pensions, earning capacity and illustrative modelling." },
        { href: "/woman-gave-up-career-divorce-uk", label: "Woman who gave up her career — divorce UK", desc: "Understanding your financial position before negotiating — illustrative, not legal advice." },
    ...
    },
    {
      ...
      links: [
        ...
        { href: "/career-sacrifice-divorce-settlement-uk", label: "Career sacrifice and divorce settlement", desc: "Pensions, earning capacity and how career breaks may be weighed in the assessment." },
        { href: "/woman-gave-up-career-divorce-uk", label: "Woman who gave up her career — divorce", desc: "Model your position privately before negotiating — illustrative financial modelling only." },
    ...
    },
    {
      ...
      links: [
        ...
        { href: "/free-divorce-calculator-uk", label: "Free Divorce Calculator UK", desc: "Model the financial implications of different settlement scenarios at no cost — no signup required." },
        { href: "/divorce-calculator-uk", label: "Divorce Calculator UK", desc: "Structured financial modelling for settlements in England and Wales — property, pensions, income, and expenses." },
        { href: "/divorce-settlement-calculator-uk", label: "Divorce Settlement Calculator UK", desc: "Model asset pool distribution, property scenarios, pension allocation, and post-separation income." },
        { href: "/fair-divorce-settlement-calculator", label: "Fair Divorce Settlement Calculator", desc: "Compare 50/50, 60/40, and needs-adjusted scenarios side by side — understand what each split means in £." },
        { href: "/divorce-asset-split-calculator", label: "Divorce Asset Split Calculator", desc: "Model how the matrimonial pool — property, savings, pensions, investments — divides under different assumptions." },
        { href: "/equity-split-divorce-calculator", label: "Equity Split Divorce Calculator", desc: "Calculate net equity, model buyout amounts, and compare different equity split ratios for the family home." },
        { href: "/divorce-pension-calculator", label: "Divorce Pension Calculator UK", desc: "Model pension sharing and offsetting scenarios — compare how pension allocation affects the full settlement." },
        { href: "/pension-sharing-calculator-divorce", label: "Pension Sharing Calculator", desc: "Model the impact of different pension sharing percentages on asset distribution and long-term position." },
        { href: "/pension-offsetting-calculator-divorce", label: "Pension Offsetting Calculator", desc: "Model pension offsetting against property equity — compare the financial trade-offs of each approach." },
        { href: "/spousal-maintenance-calculator-uk", label: "Spousal Maintenance Calculator UK", desc: "Model maintenance cashflow pressure and compare income sustainability with and without maintenance." },
        { href: "/divorce-maintenance-calculator", label: "Divorce Maintenance Calculator", desc: "Model spousal and child maintenance together — see the combined monthly cashflow impact on both parties." },
        { href: "/house-divorce-calculator", label: "House Divorce Calculator UK", desc: "Compare all four property outcomes — sell, buyout, retain, or deferred sale — with your figures." },
        { href: "/can-i-keep-the-house-after-divorce-calculator", label: "Can I Keep the House? Calculator", desc: "Model keep vs sell scenarios, buyout affordability, and mortgage sustainability on one income." },
        { href: "/mortgage-divorce-calculator", label: "Mortgage Divorce Calculator UK", desc: "Model monthly mortgage repayments and affordability on a single income after separation." },
        { href: "/divorce-cashflow-calculator", label: "Divorce Cashflow Calculator UK", desc: "Model post-separation monthly income and expenses — see whether each party's cashflow is sustainable." },
      ],
    },
  ];
