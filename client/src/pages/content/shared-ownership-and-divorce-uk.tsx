...
const faqItems = [
  ...
  { question: "Where can I find more information on shared ownership?", answer: "GOV.UK publishes guidance on shared ownership homes for buyers and existing owners. The Leasehold Advisory Service (LEASE) provides free advice on shared ownership and other leasehold matters. For divorce-specific issues, take advice from a family solicitor and a conveyancing solicitor who is familiar with shared ownership." },
];
