...
const faqItems = [
  ...
  { question: "Is offsetting the NHS pension against the house appropriate?", answer: "It needs careful modelling, particularly for substantial NHS final-salary benefits. The CETV typically understates real value, so a face-value CETV-to-house comparison may not reflect lifetime income differences. Specialist input from a Pensions on Divorce Expert is commonly used before agreeing offsetting." },
  ...
  { question: "How long does an NHS pension share take to implement?", answer: "After the sealed pension sharing order, NHS Pensions has four months to implement the share. The receiving party then becomes a pension credit member with their own benefits. Statements confirming the new pension credit typically follow within a further 1–2 months." },
];
      ...
      <ContentSection>
        ...
        <div className="space-y-3 mb-6">
          {[
            ...
            { label: "Survivor benefits", desc: "NHS pensions provide spouse's pensions on death. Pension sharing creates a clean break — the receiving party gets their own NHS benefits — but the sharing party's surviving partner (if any) may lose survivor cover on the shared portion." },
