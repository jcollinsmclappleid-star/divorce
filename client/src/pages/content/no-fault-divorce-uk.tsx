...
const faqItems = [
  ...
  { question: "Should I get the final order before sorting finances?", answer: "Almost always no. Applying for the final order before a sealed financial consent order is in place can put pension rights, widow/widower benefits and other entitlements at risk if your spouse later dies. Most family solicitors advise sealing the financial order first, then applying for the final order." },
