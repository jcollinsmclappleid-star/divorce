...
const faqItems = [
  ...
  { question: "Can I get a final order without a financial settlement?", answer: "Technically yes, but most family solicitors strongly advise against it. Once the marriage is legally ended, certain pension survivor rights and other entitlements are lost. If your spouse died after the final order but before a financial settlement, you could lose substantial benefits." },
        ...
        <Card className="border-amber-200 bg-amber-50 mb-6">
          <CardContent className="pt-5">
            <div className="flex items-start gap-3">
              ...
              <p className="text-sm text-amber-700">The most expensive mistake made under both regimes is the same: applying for the final order (or decree absolute) before a financial consent order has been sealed. This can permanently lose pension survivor benefits, widow/widower's pension entitlements and other rights tied to being legally married.</p>
            </div>
          </CardContent>
        </Card>
      </ContentSection>
