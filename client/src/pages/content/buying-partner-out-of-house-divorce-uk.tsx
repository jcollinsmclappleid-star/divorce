...
const steps = [
  ...
  { step: "4", title: "Apply to the lender for a transfer of equity", desc: "Your mortgage lender must agree to remove your ex from the mortgage and add you as the sole borrower. They will reassess your affordability as a sole applicant based on your income. The lender may decline, so obtain a mortgage in principle before relying on the route." },
