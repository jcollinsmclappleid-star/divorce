...
const faqItems = [
  ...
  { question: "When should I be cautious about DIY?", answer: "Where there are contested issues — property, pensions, businesses, complex assets, children's arrangements — fully DIY may be risky. Mistakes in financial settlements can cost far more than the price of a solicitor. Mediation with a qualified family mediator may be worth considering." },
