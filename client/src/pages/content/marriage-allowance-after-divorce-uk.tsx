...
const factors = [
  ...
  { label: "HMRC needs to be told about the change", desc: "HMRC will not always automatically know about a divorce or separation. Circumstances can be updated through the Personal Tax Account on GOV.UK. Whichever spouse made the original Marriage Allowance election can normally cancel it; the receiving spouse can also notify HMRC if they no longer want to receive the transfer." },
