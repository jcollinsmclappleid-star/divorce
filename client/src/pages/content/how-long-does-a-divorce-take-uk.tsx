...
const stages = [
  ...
  { title: "Conditional order (around week 22–26)", desc: "Apply for the conditional order after the 20 weeks. The court usually grants it within 4–8 weeks. The marriage is not yet ended. Financial consent orders can now be lodged for approval." },
