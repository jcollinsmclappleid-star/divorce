...
const points = [
  ...
  { title: "Length of marriage typically supports equal sharing", desc: "After 25, 30 or 40 years of marriage, courts typically start from a position of equal sharing of all matrimonial assets — including pensions built up during the marriage. Pre-marital pension contributions may sometimes be ringfenced." },
  { title: "State pension entitlements need review", desc: "State pension is not directly shareable on divorce, but each party's National Insurance record is — including any 'Home Responsibilities Protection' or credits during child-rearing. Both parties should request State Pension forecasts from gov.uk." },
