...
const points = [
  ...
  { title: "Indications from the judge", desc: "The whole point of FDR is for the judge to give a steer — what they would do if they were trying the case, where each side's position is weak or strong, and what a sensible settlement might look like. These indications carry significant weight." },
  { title: "Settlement rate is high", desc: "Around 60–70% of cases settle at or shortly after FDR. The combination of judicial indication, costs pressure, and the cooler reality of being in court usually concentrates minds." },
