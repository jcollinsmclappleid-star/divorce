...
const factors = [
  ...
  { label: "Assets brought in from a first marriage need evidence", desc: "Capital received as a settlement from a first divorce, or assets retained from before the second marriage, may need separate review. Length of the second marriage, how the assets were used, and overall needs all matter." },
...
const faqItems = [
  ...
  { question: "Should second marriages have a prenup?", answer: "Some couples consider a prenup where there are significant pre-marital assets, children from previous relationships, or business interests. A properly prepared prenup — with full disclosure, independent advice, and enough time before the wedding — can carry weight, but it needs case-specific legal advice." },
        ...
        <Card className="mb-6">
          <CardContent className="pt-5 space-y-3">
            ...
            <div className="space-y-2 text-sm text-muted-foreground">
              ...
              <div className="flex items-center gap-2"><Users className="w-4 h-4 text-primary" /><span>A professional review may look separately at pre-marital property, the wife's £80k inheritance/settlement, what was built together during the 6-year marriage, and how CMS payments affect affordability.</span></div>
            </div>
