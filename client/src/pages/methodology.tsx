    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-12 max-w-3xl">
        ...
        <div className="prose prose-sm max-w-none space-y-6 text-muted-foreground">
          ...
          <section>
            <h2 className="text-xl font-semibold text-foreground">4. Cashflow Resilience Indicator</h2>
            <p>The Cashflow Resilience Indicator (CRI) is a composite metric generated by the model. It is calculated by applying deductions from a base score of 100 based on the following factors:</p>
            <ul className="list-disc pl-6 space-y-1">
