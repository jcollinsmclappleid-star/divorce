...
export const EXAMPLE_SCENARIOS: ExampleScenario[] = [
  {
    ...
    data: {
      ...
      expenses: [
        { id: uuidv4(), name: "Council Tax", owner: "shared", amountAnnual: 2400, category: "housing", inflationLinked: true },
        { id: uuidv4(), name: "Utilities", owner: "shared", amountAnnual: 3600, category: "utilities", inflationLinked: true },
        { id: uuidv4(), name: "Food & Groceries", owner: "shared", amountAnnual: 6000, category: "food", inflationLinked: true },
        { id: uuidv4(), name: "Transport", owner: "shared", amountAnnual: 3000, category: "transport", inflationLinked: true },
        { id: uuidv4(), name: "Insurance", owner: "shared", amountAnnual: 1800, category: "insurance", inflationLinked: false },
        { id: uuidv4(), name: "Personal & Clothing", owner: "shared", amountAnnual: 2400, category: "personal", inflationLinked: true },
      ],
  ...
  },
  {
    ...
    data: {
      ...
      expenses: [
        { id: uuidv4(), name: "Council Tax", owner: "shared", amountAnnual: 2100, category: "housing", inflationLinked: true },
        { id: uuidv4(), name: "Utilities", owner: "shared", amountAnnual: 3200, category: "utilities", inflationLinked: true },
        { id: uuidv4(), name: "Food & Groceries", owner: "shared", amountAnnual: 7200, category: "food", inflationLinked: true },
        { id: uuidv4(), name: "Childcare / Activities", owner: "shared", amountAnnual: 4800, category: "childcare", inflationLinked: true },
        { id: uuidv4(), name: "Transport", owner: "shared", amountAnnual: 2400, category: "transport", inflationLinked: true },
  ...
  },
  {
    ...
    data: {
      ...
      expenses: [
        { id: uuidv4(), name: "Council Tax", owner: "shared", amountAnnual: 3200, category: "housing", inflationLinked: true },
        { id: uuidv4(), name: "Utilities", owner: "shared", amountAnnual: 4200, category: "utilities", inflationLinked: true },
        { id: uuidv4(), name: "Food & Groceries", owner: "shared", amountAnnual: 7800, category: "food", inflationLinked: true },
        { id: uuidv4(), name: "Insurance & Health", owner: "shared", amountAnnual: 3600, category: "insurance", inflationLinked: false },
        { id: uuidv4(), name: "Transport", owner: "shared", amountAnnual: 3000, category: "transport", inflationLinked: true },
        { id: uuidv4(), name: "Personal & Leisure", owner: "shared", amountAnnual: 4800, category: "personal", inflationLinked: true },
      ],
      config: { taxYear: "2025/26", currency: "GBP" },
      scenarios: {
        S1_Sell_Split: { enabled: true, params: {} },
