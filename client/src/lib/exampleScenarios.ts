...
export const EXAMPLE_SCENARIOS: ExampleScenario[] = [
  {
    ...
    data: {
      ...
      profile: { partyAName: "", partyBName: "", processStage: "", mainPriority: "", capturedEmail: "", calculationIntent: "", offerStatus: "" },
      maintenance: { included: false, monthlyAmount: 0, direction: "AtoB" as const },
      guidedSummary: null,
      guidedSummaryStatus: "idle" as const,
    },
  },
  {
